# ResLogit
Residual Logit (ResLogit) models are a family of machine learning based fully interpretable choice models under development in the [Laboratory of Innovations in Transportation (LiTrans)](https://litrans.ca/). So far, two models are available for general consumption:
### 1. Standard ResLogit
...
### 3. Copula-Reslogit
Kamal, Kimia, and Bilal Farooq. "[Copula-ResLogit: A Deep-Copula Framework for Unobserved Confounding Effects.](https://arxiv.org/abs/2603.10284)" arXiv preprint arXiv:2603.10284 (2026).
### 4. Attention-Reslogit
Coming soon...
...
# Contributors
- [Rulla Al Haideri](https://github.com/rulla90)
